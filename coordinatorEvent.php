...
<head>
     ...
     <link rel="stylesheet" href="styles/coordinatorEvents.css" />
     <title>Home</title>
</head>
...
<body>
     <header>
          <div class="nav">
               ...
               <li><a href="coordinatorEvent.php"style="background: rgba(76, 68, 182, 0.808); color: #fff">Events</a></li>
     ...
     <div class="container">
          <div class="posted-events">
               <div class="event-header">
                  <marquee>  <h3 style="font-size:20px;">Event Notification Updates</h3> </marquee>
               </div>
			   <?php
			...
			?>
               <div class="posts">
                    <div class="event-name">
                       <p>Event Name:<?php echo $data["ename"];?></p>
                    </div>
